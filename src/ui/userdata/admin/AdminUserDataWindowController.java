...
public class AdminUserDataWindowController {
    ...
    @FXML
    private Button btnSearch, btnClear, btnAddUser,
            btnModifyUser, btnDeleteUser;
    private final String btnSearchText = "Search", btnClearText = "Clear", btnModifyUserText = "Add user",
            btnAddUserText = "Add user", btnDeleteUserText = "Delete user";

    @FXML
    private TextField txtSearchValue, txtLogin,
            txtEmail, txtFullName;
    private final String txtSearchValuePromptText = "Search", txtLoginPromptText = "Login",
            txtEmailPromptText = "Email", txtFullNamePromptText = "Full name";

    @FXML
    private ComboBox<String> comboBoxSearchParameter,
            comboBoxMemberStatusSearch, comboBoxMembershipPlans;
    private final String comboBoxSearchParameterText = "Parameter",
            comboBoxMembershipPlansText = "Membership plans";

    @FXML
    private DatePicker datePickerStart,
            datePickerEnd;
    private final String datePickerStartText = "Membership starting date",
    ...
    @FXML
    private TableColumn<User, String> tbColLogin, tbColFullName, tbColEmail, tbColStatus,
    ...
    private void handleTextChanged(
        ...
        if (!txtSearchValue.getText().isEmpty()) {
            ...
            switch (comboBoxSearchParameter
                    .getSelectionModel()
                    .getSelectedItem().toString()) {

                case "Login":
                    nicely = AUDW.isLoginFormat(txtSearchValue.getText());

                    break;

                case "Email":
                    nicely = AUDW.isEmailFormat(txtSearchValue.getText());
                    break;

                case "Full Name":
                    nicely = AUDW.isNameFormat(txtSearchValue.getText());
                    break;
    ...
    private boolean everyUserParamAreFull() {
        ...
        return AUDW.isLoginFormat(txtLogin.getText())
